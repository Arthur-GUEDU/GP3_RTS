...
public class MenuController : MonoBehaviour
{
    ...
    [HideInInspector] public Toggle SquadAgressivenessToggle = null;
    ...
    public void ShowSquadMenu(bool _isAgressive)
    {
        if (SquadMenuPanel)
            SquadMenuPanel.SetActive(true);
        if (SquadAgressivenessToggle != null)
            SquadAgressivenessToggle.isOn = _isAgressive;
        HideFactoryMenu();
    }
    ...
    void Awake()
    {
        ...
        else
        {
            ...
            Transform SquadMenuPanelTransform = FactoryMenuCanvas.Find("SquadMenu_Panel");
    ...
    void Start()
    {
        ...
        SquadAgressivenessToggle = SquadMenuPanel.GetComponentInChildren<Toggle>();
    }
}
